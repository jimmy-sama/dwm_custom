...
static const Key keys[] = {
	...
	{0, XF86XK_AudioPlay,			   spawn,	   SHCMD("rmpc remote keybind p")},
	{0, XF86XK_AudioPrev,			   spawn,	   SHCMD("rmpc remote keybind '<'")},
	{0, XF86XK_AudioNext,			   spawn,	   SHCMD("rmpc remote keybind '>'")},
